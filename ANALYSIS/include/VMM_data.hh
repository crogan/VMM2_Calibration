...
// Tue Jun  7 11:27:12 2016 by ROOT version 5.34/25
// from TTree VMM_data/VMM_data
...
inline void VMM_data::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("BCIDtrig", &BCIDtrig, &b_BCIDtrig);
   ...
   fChain->SetBranchAddress("FIFO", &FIFO, &b_FIFO);
