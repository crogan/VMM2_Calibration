...
inline TPFitBase::TPFitBase(TTree *tree) : fChain(0)
{
...
inline TPFitBase::~TPFitBase()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

inline Int_t TPFitBase::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
inline Long64_t TPFitBase::LoadTree(Long64_t entry)
{
...
inline void TPFitBase::Init(TTree *tree)
{
...
inline Bool_t TPFitBase::Notify()
{
...
inline void TPFitBase::Show(Long64_t entry)
{
...
inline Int_t TPFitBase::Cut(Long64_t entry)
{
